...
from howlplane.control_plane.reconciliation import ReconciliationResult
...
class HumanBoundaryGate:
    ...
    def evaluate_with_delegated_authority(
        ...
        **kwargs: Any,
        ...
        from howlplane.control_plane.proposed_action import infer_proposed_actions_from_diff
...
def compute_repository_fingerprint(
    ...
    if task_run_dir and (Path(task_run_dir) / "baseline.json").is_file():
        try:
            from howlplane.control_plane.git_baseline import capture_delta, GitBaseline
...
class HumanLifecycleManager:
    ...
    def reject(
        ...
        try:
            from howlplane.control_plane.checkpoints import CheckpointManager
    ...
    def resume(
        ...
        from howlplane.control_plane.locking import TaskLock
        from howlplane.control_plane.proposed_action import infer_proposed_actions, ProposedAction
