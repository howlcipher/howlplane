...
SELF_MODIFICATION_PATHS: Tuple[str, ...] = (
    ...
    "src/howlplane/control_plane/executor.py",
    "src/howlplane/control_plane/reviewers.py",
    "src/howlplane/control_plane/review_runner.py",
    "src/howlplane/control_plane/reconciliation.py",
    "src/howlplane/control_plane/verification.py",
    "src/howlplane/control_plane/hygiene_policy.py",
)
...
SELF_MODIFICATION_PATH_PREFIXES: Tuple[str, ...] = (
    "src/howlplane/control_plane/factory/",
