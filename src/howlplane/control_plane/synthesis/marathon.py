...
from howlplane.control_plane.git_baseline import capture_baseline, capture_delta, describe_working_tree, is_baseline_restored
from howlplane.control_plane.git_integration import GitIntegrationExecutor, detect_repo_slug, run_git
...
from howlplane.control_plane.backlog_source import DEFAULT_BACKLOG_FILES
...
class MarathonDogfoodEngine:
    ...
    def run_marathon(
        ...
        if self.authority_envelope is not None:
            ...
            # binds an envelope.
            from howlplane.control_plane.agent_execution import OllamaLocalBackend
