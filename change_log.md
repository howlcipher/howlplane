...
## [Unreleased]
### Added
- **Milestone #60B Reasoning Evidence Campaign Start**: created the durable campaign journal on the required main SHA, bounded collection to approximately six through ten new live trajectories when providers permit, and preserved the evidence only boundary. No experiment has started, no learned preference exists, and unavailable dimensions will be recorded rather than manufactured.
